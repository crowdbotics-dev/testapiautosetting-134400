...
class Testconnectors134400ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134400_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134400_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134400"
